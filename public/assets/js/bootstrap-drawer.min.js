/* prettier-ignore */ ! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], t) : t((e = e || self)["bootstrap-drawer"] = {}, e.jQuery)
}(this, function(e, s) {
    "use strict";
    ...
    s.fn.emulateTransitionEnd = n, s.event.special[l.TRANSITION_END] = {
        bindType: t,
        delegateType: t,
        handle: function(e) {
    ...
    var r = "drawer",
        ...
        I = '[data-dismiss="drawer"]',
        D = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
        k = ".sticky-top",
        N = function() {
            function o(e, t) {
                this._config = this._getConfig(t), this._element = e, this._content = e.querySelector(v), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            var e = o.prototype;
            return e.toggle = function(e) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        s(this._element).hasClass(p) && (this._isTransitioning = !0);
                        var n = s.Event(f.SHOW, {
                            relatedTarget: e
                        });
                        s(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._setEscapeEvent(), s(this._element).on(f.CLICK_DISMISS, I, function(e) {
                            return t.hide(e)
                        }), s(this._content).on(f.MOUSEDOWN_DISMISS, function() {
                            s(t._element).one(f.MOUSEUP_DISMISS, function(e) {
                    ...
                    if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                        ...
                        if (s(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                            ...
                            if (i && (this._isTransitioning = !0), this._setEscapeEvent(), s(document).off(f.FOCUSIN), s(this._element).removeClass(b), s(this._element).off(f.CLICK_DISMISS), s(this._content).off(f.MOUSEDOWN_DISMISS), i) {
                                var o = l.getTransitionDurationFromElement(this._element);
                                s(this._element).one(l.TRANSITION_END, function(e) {
                    ...
                    [window, this._element, this._content].forEach(function(e) {
                        return s(e).off(d)
                    }), s(document).off(f.FOCUSIN), s.removeData(this._element, c), this._config = null, this._element = null, this._content = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
                    ...
                    var o = s.Event(f.SHOWN, {
                        relatedTarget: e
                    });
                    if (n) {
                        var r = l.getTransitionDurationFromElement(this._element);
                        s(this._element).one(l.TRANSITION_END, i).emulateTransitionEnd(r)
                    } else i()
                }, e._enforceFocus = function() {
                    var t = this;
                    s(document).off(f.FOCUSIN).on(f.FOCUSIN, function(e) {
                        document !== e.target && t._element !== e.target && 0 === s(t._element).has(e.target).length && t._element.focus()
                    })
                }, e._setEscapeEvent = function() {
                    var t = this;
                    this._isShown && this._config.keyboard ? s(document.body).on(f.KEYDOWN_DISMISS, function(e) {
                        27 === e.which && (e.preventDefault(), t.hide())
                    }) : this._isShown || s(document.body).off(f.KEYDOWN_DISMISS)
                }, e._hideDrawer = function() {
                    var e = this;
                    this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                        s(document.body).removeClass(y), e._resetAdjustments(), e._resetScrollbar(), s(e._element).trigger(f.HIDDEN)
                    })
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (this._backdrop = document.createElement("div"), this._backdrop.className = g, n && this._backdrop.classList.add(n), s(this._backdrop).appendTo(document.body), s(this._backdrop).on(f.CLICK_DISMISS, function(e) {
                                t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                            }), n && l.reflow(this._backdrop), s(this._backdrop).addClass(b), !e) return;
                        if (!n) return e();
                        var i = l.getTransitionDurationFromElement(this._backdrop);
                        s(this._backdrop).one(l.TRANSITION_END, e).emulateTransitionEnd(i)
                        ...
                        if (s(this._element).hasClass(p)) {
                            ...
                            s(this._backdrop).one(l.TRANSITION_END, o).emulateTransitionEnd(r)
                        } else o()
                    } else e && e()
                    ...
                    return this.each(function() {
                        var e = s(this).data(c),
                            t = a({}, h, s(this).data(), "object" == typeof n && n ? n : {});
                        if (e || (e = new o(this, t), s(this).data(c, e)), "string" == typeof n) {
    ...
    s(document).on(f.CLICK_DATA_API, E, function(e) {
        ...
        var r = s(t).one(f.SHOW, function(e) {
            e.isDefaultPrevented() || r.one(f.HIDDEN, function() {
                s(n).is(":visible") && n.focus()
            })
        });
        N._jQueryInterface.call(s(t), o, this)
    }), s.fn[r] = N._jQueryInterface, s.fn[r].Constructor = N, s.fn[r].noConflict = function() {
        return s.fn[r] = o, N._jQueryInterface
    }, e.Drawer = N, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});